...
/**
  * @brief  Clear Status of End of Erase for ICACHE and RAMs
...
/**
  * @brief  Get Status of End of Erase for ICACHE and RAMs
...
/**
  * @brief  Clear Status of End of Erase after reset  for SRAM2, BKPRAM, ICACHE, DCACHE rams
...
/**
  * @brief  Get Status of End of Erase after reset  for SRAM2, BKPRAM, ICACHE, DCACHE rams
