...
#define BUS_I2C1_SMBA_GPIO_CLK_DISABLE() __HAL_RCC_GPIOG_CLK_DISABLE()
#define BUS_I2C1_SMBA_GPIO_PORT GPIOG
#define BUS_I2C1_SMBA_GPIO_CLK_ENABLE() __HAL_RCC_GPIOG_CLK_ENABLE()
#define BUS_I2C1_SMBA_GPIO_AF GPIO_AF4_I2C1
#define BUS_I2C1_SMBA_GPIO_PIN GPIO_PIN_15
