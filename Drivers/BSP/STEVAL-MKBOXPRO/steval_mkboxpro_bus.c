...
static void I2C1_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = BUS_I2C1_SMBA_GPIO_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = BUS_I2C1_SMBA_GPIO_AF;
    HAL_GPIO_Init(BUS_I2C1_SMBA_GPIO_PORT, &GPIO_InitStruct);
...
static void I2C1_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(BUS_I2C1_SMBA_GPIO_PORT, BUS_I2C1_SMBA_GPIO_PIN);
