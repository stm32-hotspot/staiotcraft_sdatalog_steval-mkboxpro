...
/**
  ******************************************************************************
  * @file    usart_aspep_driver_F4.c
  * @author  STMicroelectronics
  * @brief   UART ASPEP driver implementation for STM32F4
  *
  ******************************************************************************
  * @attention
  *
...
void UASPEP_Usart_Handler(void *pHandle)
{
  ...
  if ((LL_USART_IsActiveFlag_ORE(ASPEP_USART_A) || LL_USART_IsActiveFlag_FE(ASPEP_USART_A)
       || LL_USART_IsActiveFlag_NE(ASPEP_USART_A)) && LL_USART_IsEnabledIT_ERROR(ASPEP_USART_A))
  {
